 ...
 * @generated
 */
public class TaxiSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case TaxiPackage.USER: {
				User user = (User)theEObject;
				T result = caseUser(user);
				if (result == null) result = caseIdentifiable(user);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TaxiPackage.CUSTOMER: {
				...
				if (result == null) result = caseIdentifiable(customer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TaxiPackage.RIDER: {
				...
				if (result == null) result = caseUser(rider);
				if (result == null) result = caseIdentifiable(rider);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case TaxiPackage.ROUTE: {
				...
				if (result == null) result = caseIdentifiable(route);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TaxiPackage.IDENTIFIABLE: {
