 ...
 * @generated
 */
public class TaxiPackageImpl extends EPackageImpl implements TaxiPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see taxi.TaxiPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private TaxiPackageImpl() {
		super(eNS_URI, TaxiFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link TaxiPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static TaxiPackage init() {
		if (isInited) return (TaxiPackage)EPackage.Registry.INSTANCE.getEPackage(TaxiPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredTaxiPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		TaxiPackageImpl theTaxiPackage = registeredTaxiPackage instanceof TaxiPackageImpl ? (TaxiPackageImpl)registeredTaxiPackage : new TaxiPackageImpl();

		isInited = true;

		// Create package meta-data objects
		theTaxiPackage.createPackageContents();

		// Initialize created meta-data
		theTaxiPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theTaxiPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(TaxiPackage.eNS_URI, theTaxiPackage);
		return theTaxiPackage;
	}
	...
	public TaxiFactory getTaxiFactory() {
		return (TaxiFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getCompany_Manager(), ecorePackage.getEString(), "manager", null, 0, 1, Company.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCompany_Riders(), this.getRider(), null, "riders", null, 0, -1, Company.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCompany_Routes(), this.getRoute(), null, "routes", null, 0, -1, Company.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCustomer_SubscriptionDate(), ecorePackage.getEString(), "subscriptionDate", null, 0, 1, Customer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCustomer_ExpirationDate(), ecorePackage.getEString(), "expirationDate", null, 1, 1, Customer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCustomer_Status(), this.getCustomerStatus(), "status", null, 1, 1, Customer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCustomer_Routes(), this.getRoute(), this.getRoute_Customer(), "routes", null, 0, -1, Customer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(riderEClass, Rider.class, "Rider", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getRider_Status(), this.getRiderStatus(), "status", null, 1, 1, Rider.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRider_LivePosition(), this.getGeolocation(), null, "livePosition", null, 0, 1, Rider.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRider_Routes(), this.getRoute(), this.getRoute_Rider(), "routes", null, 0, -1, Rider.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(geolocationEClass, Geolocation.class, "Geolocation", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getGeolocation_Lat(), ecorePackage.getEDouble(), "lat", null, 1, 1, Geolocation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getGeolocation_Lng(), ecorePackage.getEDouble(), "lng", null, 0, 1, Geolocation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(routeEClass, Route.class, "Route", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getRoute_Price(), ecorePackage.getEDouble(), "price", null, 1, 1, Route.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRoute_Date(), ecorePackage.getEString(), "date", null, 1, 1, Route.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRoute_StartAddress(), ecorePackage.getEString(), "startAddress", null, 1, 1, Route.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRoute_EndAddress(), ecorePackage.getEString(), "endAddress", null, 1, 1, Route.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRoute_Feedback(), ecorePackage.getEInt(), "feedback", "0", 1, 1, Route.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRoute_Status(), this.getRouteStatus(), "status", null, 1, 1, Route.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRoute_Customer(), this.getCustomer(), this.getCustomer_Routes(), "customer", null, 1, 1, Route.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRoute_Rider(), this.getRider(), this.getRider_Routes(), "rider", null, 1, 1, Route.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRoute_Seat(), ecorePackage.getEInt(), "seat", null, 1, 1, Route.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
