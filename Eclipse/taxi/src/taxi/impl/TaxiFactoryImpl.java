 ...
 * @generated
 */
public class TaxiFactoryImpl extends EFactoryImpl implements TaxiFactory {
	/**
	 ...
	 * @generated
	 */
	public static TaxiFactory init() {
		try {
			TaxiFactory theTaxiFactory = (TaxiFactory)EPackage.Registry.INSTANCE.getEFactory(TaxiPackage.eNS_URI);
			if (theTaxiFactory != null) {
				return theTaxiFactory;
			}
		}
		catch (Exception exception) {
			EcorePlugin.INSTANCE.log(exception);
		}
		return new TaxiFactoryImpl();
	}
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case TaxiPackage.COMPANY: return createCompany();
			case TaxiPackage.CUSTOMER: return createCustomer();
			case TaxiPackage.RIDER: return createRider();
			case TaxiPackage.GEOLOCATION: return createGeolocation();
			case TaxiPackage.ROUTE: return createRoute();
			default:
	 ...
	 * @generated
	 */
	public TaxiPackage getTaxiPackage() {
		return (TaxiPackage)getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static TaxiPackage getPackage() {
		return TaxiPackage.eINSTANCE;
	}
