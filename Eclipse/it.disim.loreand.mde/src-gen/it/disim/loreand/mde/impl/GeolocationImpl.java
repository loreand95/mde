 ...
 * </p>
 * <ul>
 *   <li>{@link it.disim.loreand.mde.impl.GeolocationImpl#getLat <em>Lat</em>}</li>
 *   <li>{@link it.disim.loreand.mde.impl.GeolocationImpl#getLng <em>Lng</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GeolocationImpl extends MinimalEObjectImpl.Container implements Geolocation {
	...
	protected EClass eStaticClass() {
		return MdePackage.Literals.GEOLOCATION;
	}
	...
	public void setLat(double newLat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MdePackage.GEOLOCATION__LAT, oldLat, lat));
	}
	...
	public void setLng(double newLng) {
		...
		lng = newLng;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MdePackage.GEOLOCATION__LNG, oldLng, lng));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case MdePackage.GEOLOCATION__LAT:
			return getLat();
		case MdePackage.GEOLOCATION__LNG:
			return getLng();
		}
