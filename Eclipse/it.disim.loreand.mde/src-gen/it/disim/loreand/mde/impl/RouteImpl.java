 ...
 * </p>
 * <ul>
 *   <li>{@link it.disim.loreand.mde.impl.RouteImpl#getId <em>Id</em>}</li>
 *   <li>{@link it.disim.loreand.mde.impl.RouteImpl#getPrice <em>Price</em>}</li>
 *   <li>{@link it.disim.loreand.mde.impl.RouteImpl#getDate <em>Date</em>}</li>
 *   <li>{@link it.disim.loreand.mde.impl.RouteImpl#getStartAddress <em>Start Address</em>}</li>
 *   <li>{@link it.disim.loreand.mde.impl.RouteImpl#getEndAddress <em>End Address</em>}</li>
 *   <li>{@link it.disim.loreand.mde.impl.RouteImpl#getFeedback <em>Feedback</em>}</li>
 *   <li>{@link it.disim.loreand.mde.impl.RouteImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link it.disim.loreand.mde.impl.RouteImpl#getCustomer <em>Customer</em>}</li>
 *   <li>{@link it.disim.loreand.mde.impl.RouteImpl#getRider <em>Rider</em>}</li>
 *   <li>{@link it.disim.loreand.mde.impl.RouteImpl#getSeats <em>Seats</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RouteImpl extends MinimalEObjectImpl.Container implements Route {
	...
	protected EClass eStaticClass() {
		return MdePackage.Literals.ROUTE;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MdePackage.ROUTE__ID, oldId, id));
	}
	...
	public void setPrice(double newPrice) {
		...
		price = newPrice;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MdePackage.ROUTE__PRICE, oldPrice, price));
	}
	...
	public void setDate(Date newDate) {
		...
		date = newDate;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MdePackage.ROUTE__DATE, oldDate, date));
	}
	...
	public void setStartAddress(String newStartAddress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MdePackage.ROUTE__START_ADDRESS, oldStartAddress,
					startAddress));
	}
	...
	public void setEndAddress(String newEndAddress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MdePackage.ROUTE__END_ADDRESS, oldEndAddress,
					endAddress));
	}
	...
	public void setFeedback(int newFeedback) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MdePackage.ROUTE__FEEDBACK, oldFeedback, feedback));
	}
	...
	public void setStatus(RouteStatus newStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MdePackage.ROUTE__STATUS, oldStatus, status));
	}
	...
	public Customer getCustomer() {
		if (customer != null && customer.eIsProxy()) {
			...
			if (customer != oldCustomer) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MdePackage.ROUTE__CUSTOMER, oldCustomer,
							customer));
			}
		}
		return customer;
	...
	public NotificationChain basicSetCustomer(Customer newCustomer, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MdePackage.ROUTE__CUSTOMER,
	...
	public void setCustomer(Customer newCustomer) {
		if (newCustomer != customer) {
			...
			if (customer != null)
				msgs = ((InternalEObject) customer).eInverseRemove(this, MdePackage.CUSTOMER__ROUTES, Customer.class,
						msgs);
			if (newCustomer != null)
				msgs = ((InternalEObject) newCustomer).eInverseAdd(this, MdePackage.CUSTOMER__ROUTES, Customer.class,
						msgs);
			msgs = basicSetCustomer(newCustomer, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MdePackage.ROUTE__CUSTOMER, newCustomer,
					newCustomer));
	}
	...
	public Rider getRider() {
		if (rider != null && rider.eIsProxy()) {
			...
			if (rider != oldRider) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MdePackage.ROUTE__RIDER, oldRider,
							rider));
			}
		}
		return rider;
	...
	public NotificationChain basicSetRider(Rider newRider, NotificationChain msgs) {
		...
		rider = newRider;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MdePackage.ROUTE__RIDER,
					oldRider, newRider);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setRider(Rider newRider) {
		if (newRider != rider) {
			NotificationChain msgs = null;
			if (rider != null)
				msgs = ((InternalEObject) rider).eInverseRemove(this, MdePackage.RIDER__ROUTES, Rider.class, msgs);
			if (newRider != null)
				msgs = ((InternalEObject) newRider).eInverseAdd(this, MdePackage.RIDER__ROUTES, Rider.class, msgs);
			msgs = basicSetRider(newRider, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MdePackage.ROUTE__RIDER, newRider, newRider));
	}
	...
	public void setSeats(int newSeats) {
		...
		seats = newSeats;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MdePackage.ROUTE__SEATS, oldSeats, seats));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case MdePackage.ROUTE__CUSTOMER:
			if (customer != null)
				msgs = ((InternalEObject) customer).eInverseRemove(this, MdePackage.CUSTOMER__ROUTES, Customer.class,
						msgs);
			return basicSetCustomer((Customer) otherEnd, msgs);
		case MdePackage.ROUTE__RIDER:
			if (rider != null)
				msgs = ((InternalEObject) rider).eInverseRemove(this, MdePackage.RIDER__ROUTES, Rider.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case MdePackage.ROUTE__ID:
			return getId();
		case MdePackage.ROUTE__PRICE:
			return getPrice();
		case MdePackage.ROUTE__DATE:
			return getDate();
		case MdePackage.ROUTE__START_ADDRESS:
			return getStartAddress();
		case MdePackage.ROUTE__END_ADDRESS:
			return getEndAddress();
		case MdePackage.ROUTE__FEEDBACK:
			return getFeedback();
		case MdePackage.ROUTE__STATUS:
			return getStatus();
		case MdePackage.ROUTE__CUSTOMER:
			if (resolve)
				return getCustomer();
