 ...
 * </p>
 * <ul>
 *   <li>{@link it.disim.loreand.mde.impl.CustomerImpl#getSubscriptionDate <em>Subscription Date</em>}</li>
 *   <li>{@link it.disim.loreand.mde.impl.CustomerImpl#getExpirationDate <em>Expiration Date</em>}</li>
 *   <li>{@link it.disim.loreand.mde.impl.CustomerImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link it.disim.loreand.mde.impl.CustomerImpl#getRoutes <em>Routes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CustomerImpl extends UserImpl implements Customer {
	...
	protected EClass eStaticClass() {
		return MdePackage.Literals.CUSTOMER;
	}
	...
	public void setSubscriptionDate(Date newSubscriptionDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MdePackage.CUSTOMER__SUBSCRIPTION_DATE,
	...
	public void setExpirationDate(Date newExpirationDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MdePackage.CUSTOMER__EXPIRATION_DATE,
	...
	public void setStatus(CustomerStatus newStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MdePackage.CUSTOMER__STATUS, oldStatus, status));
	}
	...
	public EList<Route> getRoutes() {
		if (routes == null) {
			routes = new EObjectWithInverseResolvingEList<Route>(Route.class, this, MdePackage.CUSTOMER__ROUTES,
					MdePackage.ROUTE__CUSTOMER);
		}
		return routes;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case MdePackage.CUSTOMER__ROUTES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case MdePackage.CUSTOMER__SUBSCRIPTION_DATE:
			return getSubscriptionDate();
		case MdePackage.CUSTOMER__EXPIRATION_DATE:
			return getExpirationDate();
		case MdePackage.CUSTOMER__STATUS:
			return getStatus();
		case MdePackage.CUSTOMER__ROUTES:
			return getRoutes();
		}
