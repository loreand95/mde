 ...
 * </p>
 * <ul>
 *   <li>{@link it.disim.mde.loreand.uber.impl.RouteImpl#getId <em>Id</em>}</li>
 *   <li>{@link it.disim.mde.loreand.uber.impl.RouteImpl#getPrice <em>Price</em>}</li>
 *   <li>{@link it.disim.mde.loreand.uber.impl.RouteImpl#getDate <em>Date</em>}</li>
 *   <li>{@link it.disim.mde.loreand.uber.impl.RouteImpl#getStartAddress <em>Start Address</em>}</li>
 *   <li>{@link it.disim.mde.loreand.uber.impl.RouteImpl#getEndAddress <em>End Address</em>}</li>
 *   <li>{@link it.disim.mde.loreand.uber.impl.RouteImpl#getFeedback <em>Feedback</em>}</li>
 *   <li>{@link it.disim.mde.loreand.uber.impl.RouteImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link it.disim.mde.loreand.uber.impl.RouteImpl#getCustomer <em>Customer</em>}</li>
 *   <li>{@link it.disim.mde.loreand.uber.impl.RouteImpl#getRider <em>Rider</em>}</li>
 *   <li>{@link it.disim.mde.loreand.uber.impl.RouteImpl#getSeats <em>Seats</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RouteImpl extends MinimalEObjectImpl.Container implements Route {
	...
	public void setSeats(int newSeats) {
		...
		seats = newSeats;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UberPackage.ROUTE__SEATS, oldSeats, seats));
	}
