...
public class MyDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MyDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getCompanyAccess().getGroup_4(), "rule__Company__Group_4__0");
			builder.put(grammarAccess.getCompanyAccess().getGroup_5(), "rule__Company__Group_5__0");
			builder.put(grammarAccess.getCompanyAccess().getGroup_6(), "rule__Company__Group_6__0");
			builder.put(grammarAccess.getCompanyAccess().getGroup_6_3(), "rule__Company__Group_6_3__0");
			builder.put(grammarAccess.getCompanyAccess().getGroup_7(), "rule__Company__Group_7__0");
			builder.put(grammarAccess.getCompanyAccess().getGroup_7_3(), "rule__Company__Group_7_3__0");
			builder.put(grammarAccess.getCompanyAccess().getGroup_8(), "rule__Company__Group_8__0");
			builder.put(grammarAccess.getCompanyAccess().getGroup_8_3(), "rule__Company__Group_8_3__0");
			...
			builder.put(grammarAccess.getGeolocationAccess().getGroup_4(), "rule__Geolocation__Group_4__0");
			...
			builder.put(grammarAccess.getCompanyAccess().getManagerAssignment_4_1(), "rule__Company__ManagerAssignment_4_1");
			builder.put(grammarAccess.getCompanyAccess().getAddressAssignment_5_1(), "rule__Company__AddressAssignment_5_1");
			builder.put(grammarAccess.getCompanyAccess().getCustomersAssignment_6_2(), "rule__Company__CustomersAssignment_6_2");
			builder.put(grammarAccess.getCompanyAccess().getCustomersAssignment_6_3_1(), "rule__Company__CustomersAssignment_6_3_1");
			builder.put(grammarAccess.getCompanyAccess().getRidersAssignment_7_2(), "rule__Company__RidersAssignment_7_2");
			builder.put(grammarAccess.getCompanyAccess().getRidersAssignment_7_3_1(), "rule__Company__RidersAssignment_7_3_1");
			builder.put(grammarAccess.getCompanyAccess().getRoutesAssignment_8_2(), "rule__Company__RoutesAssignment_8_2");
			builder.put(grammarAccess.getCompanyAccess().getRoutesAssignment_8_3_1(), "rule__Company__RoutesAssignment_8_3_1");
			...
			builder.put(grammarAccess.getRiderAccess().getLivePositionAssignment_12_1(), "rule__Rider__LivePositionAssignment_12_1");
			...
			builder.put(grammarAccess.getRouteAccess().getSeatAssignment_16(), "rule__Route__SeatAssignment_16");
			...
			builder.put(grammarAccess.getGeolocationAccess().getLngAssignment_4_1(), "rule__Geolocation__LngAssignment_4_1");
		}
	}
